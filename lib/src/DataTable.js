...
var DataTable = (function () {
    ...
    DataTable.prototype.fillData = function () {
        ...
        data = data.slice().sort(this.sorter(this.sortBy, this.sortOrder));
    ...
    DataTable.prototype.compare = function (left, right) {
        return left === right ? 0 : left == null || left > right ? 1 : -1;
    };
    DataTable.prototype.sorter = function (sortBy, sortOrder) {
        var _this = this;
        var order = sortOrder === "desc" ? -1 : 1;
        if (typeof sortBy === "string" || sortBy instanceof String) {
            var iteratee_1 = this.caseInsensitiveIteratee(sortBy);
            return function (left, right) {
                return _this.compare(iteratee_1(left), iteratee_1(right)) * order;
            };
        }
        else {
            var iteratees_1 = sortBy.map(function (entry) { return _this.caseInsensitiveIteratee(entry); });
            return function (left, right) {
                for (var _i = 0, iteratees_2 = iteratees_1; _i < iteratees_2.length; _i++) {
                    var iteratee = iteratees_2[_i];
