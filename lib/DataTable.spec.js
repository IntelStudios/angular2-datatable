...
describe("DataTable directive tests", function () {
    ...
    describe("pagination", function () {
        ...
        it("should emit a dataLength of 0 when inputData is null or undefined", function (done) {
            datatable.onPageChange.subscribe(function (pageOptions) {
    ...
    describe("sorting", function () {
        ...
        it("should set sortOrder to 'asc' if setSort is given something else than 'asc' or 'desc'", function () {
            datatable.setSort("id", "bulb");
    ...
    describe("data change", function () {
        ...
        it("should fire onPageChange event after rows removed", function (done) {
            ...
            rxjs_1.range(0, 3).forEach(function () { return datatable.inputData.pop(); });
            datatable.ngDoCheck();
        });
        ...
        it("shouldn't change page to 0 when data is empty after removed rows", function () {
            datatable.setPage(2, 1);
            datatable.ngDoCheck();
            rxjs_1.range(0, 5).forEach(function () { return datatable.inputData.pop(); });
            datatable.ngDoCheck();
